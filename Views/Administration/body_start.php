<header id="h-general">
    ...
    <div class="website-info"><?php //echo $controller->getWebsiteName(); ?><span class="date"><?php //echo System::getRealtimeDate( 'jS F Y' ); ?></span></div>
    <div class="logged">
        <span class="avatar">
            <img src="https://cdn0.iconfinder.com/data/icons/user-pictures/100/malecostume-512.png">
        </span>
        <span class="name">Witaj, <b><?php //echo $controller->getUsername(); ?></b></span>
        <span class="arrow">
